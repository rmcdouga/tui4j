...
class TableTest {
    ...
    void testTableExample() {
        Style headerStyle = Style.newStyle().padding(0, 1).align(Position.Center);
    ...
    void testTableMarginAndRightAlignment() {
        Table table = Table.create()
                .border(Borders.normalBorder())
                .styleFunc((row, col) -> Style.newStyle().margin(0, 1).align(Position.Right))
                .headers("LANGUAGE", "FORMAL", "INFORMAL")
    ...
    void testTableRowSeparators() {
        ...
        assertGolden("TestTableRowSeparators/with_overflow", withOverflow.render());
    }
    ...
    void testStyleFunc() {
        Table table = Table.create()
                ...
                .styleFunc((row, col) -> {
                    ...
                    if (col == 0) {
                        return Style.newStyle().padding(0, 1).margin(0, 1).align(Position.Right);
                    }
                    return Style.newStyle().padding(0, 1);
                })
                .rows(languageRows());

        assertGolden("TestStyleFunc/RightAlignedTextWithMargins", table.render());
        ...
        Table padded = Table.create()
                ...
                .styleFunc((row, col) -> {
                    if (row == Table.HEADER_ROW) {
                        return Style.newStyle().padding(1, 2).align(Position.Center);
                    }
    ...
    void testContentWrapping() {
        Object[][] tests = new Object[][]{
                {
                        "LongRowContent",
                        new String[]{"Name", "Description", "Type", "Required", "Default"},
                        new String[][]{{"command", LONG_ROW_DESCRIPTION, "yes", "hello", "yep"}},
                        true,
                        TABLE_STYLE
                },
                {
                ...
                },
                {
                        ...
                        (StyleFunc) (row, col) -> {
                            if (row == Table.HEADER_ROW) {
                                return Style.newStyle().padding(0).align(Position.Center);
                            }
                ...
                },
                {
                        ...
                        (StyleFunc) (row, col) -> {
                            if (row == Table.HEADER_ROW) {
                                return Style.newStyle().padding(0, 2).align(Position.Center);
                            }
                ...
                },
                {
                        "MissingRowContent",
                        new String[]{"Name", "Description", "Type", "Required", "Default"},
                        new String[][]{{"command", LONG_ROW_DESCRIPTION, "yes", "", ""}},
                        true,
                        TABLE_STYLE
                },
                {
                        "LongHeaderContentLongAndShortRows",
                        new String[]{"Destination", LONG_HEADER_QUESTION, "Affordability"},
                        new String[][]{
    ...
    void testContentWrappingWithPadding() {
        ...
        String[][][] data = new String[][][]{
                ...
                {
                        {"", LONG_TEXT_JP, LONG_TEXT_AR, LONG_TEXT_KANJI, LONG_TEXT_KO}
                }
        };
        ...
        for (int i = 0; i < names.length; i++) {
            ...
            assertGolden("TestContentWrapping_WithPadding/" + names[i], table.render());
        }
    }
    ...
    void testContentWrappingWithMargins() {
        ...
        String[][][] data = new String[][][]{
                ...
                {
                        {LONG_TEXT_EN, LONG_TEXT_JP, LONG_TEXT_AR, LONG_TEXT_KANJI, LONG_TEXT_KO}
                }
        };
        ...
        for (int i = 0; i < names.length; i++) {
            ...
            assertGolden("TestContentWrapping_WithMargins/" + names[i], table.render());
        }
    }
    ...
    void testContentWrappingColumnWidth() {
        ...
        for (int i = 0; i < names.length; i++) {
            ...
            assertGolden("TestContentWrapping_ColumnWidth/" + names[i], table.render());
        }
    }

    @Test
    void testTableOverFlowNoWrap() {
        String[] headers = new String[]{"Hello", "你好", "مرحبًا", "안녕하세요"};
        String[][] data = new String[][]{
                {LONG_TEXT_EN, LONG_TEXT_JP, LONG_TEXT_AR, LONG_TEXT_KO, LONG_TEXT_KANJI},
    ...
    void testTableShrinkWithOffset() {
        ...
        assertThat(renderedHeight).as("height with offset %d", offset).isEqualTo(height);
    }
    ...
    void testBorderStyles() {
        ...
        Map<String, Border> borders = Map.of(
                "NormalBorder", Borders.normalBorder(),
                "RoundedBorder", Borders.roundedBorder(),
                "BlockBorder", Borders.blockBorder(),
                "ThickBorder", Borders.thickBorder(),
                "HiddenBorder", Borders.hiddenBorder(),
                "MarkdownBorder", Borders.markdownBorder(),
                "ASCIIBorder", Borders.asciiBorder()
        );
    ...
    void testWrapPreStyledContent() {
        ...
        Table table = Table.create()
                .border(Borders.normalBorder())
                .headers("LANGUAGE", "FORMAL", "INFORMAL")
                .styleFunc((row, col) -> row == Table.HEADER_ROW ? headerStyle : cellStyle)
                .rows(languageRows())
                .width(30);
    ...
    private static int[] getIntArray(Table table, String fieldName) {
        try {
            java.lang.reflect.Field field = Table.class.getDeclaredField(fieldName);
