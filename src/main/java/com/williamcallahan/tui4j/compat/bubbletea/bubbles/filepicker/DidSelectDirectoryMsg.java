...
import com.williamcallahan.tui4j.compat.bubbles.filepicker.DidSelectDirectoryMessage;
...
public class DidSelectDirectoryMsg extends DidSelectDirectoryMessage {
    /**
     * Creates DidSelectDirectoryMsg to keep this component ready for use.
     *
     * @param path path
     */
